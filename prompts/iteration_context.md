...
| 用户已按 `disclosure_builder.md` §7.6 声明侧重点，仅需 **第 15 项权利要求书式强化**（取向须与本稿已有材料及第 15 项、第 11 项已写观点一致，**禁止**为交互而编造新场景） | `merger.md`（以最近定稿为基准，合并范围以第 15 项为主，必要时微调第 10 项、第 11 项与第 15 项衔接句） |
